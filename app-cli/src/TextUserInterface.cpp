...
const char* TextUserInterface::kHelp =
    ...
    "    <>                              No arguments provided, return full information about all "
    "detected modules\n"
    "\n"
    "Service commands:\n"
...
const char* TextUserInterface::kBadArgument = "Bad argument '%s' provided!\n";
...
const char* TextUserInterface::kChannelNameAndState = "channel_%d:        %d\n";
